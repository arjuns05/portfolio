    ...
    return (
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300' >
                ...
                <p className='py-2 border-b mx-8 mt-8 text-base'> Fullstack application for users to store their passwords and usernames on a MongoDB server on the cloud. Secured using BCrypt encyrption libraries for advanced security and authentication</p>
       ...
       <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300' >
                <img className = 'w-d20 mx-auto mt-[-30] bg-white' src = {health} alt = '/' />
                <h2 className='text-2xl font-bold text-center py-8'>
                    HealthAI
                </h2>
                <div className = 'text-center font-medium'>
                <p className='py-2 border-b mx-8 mt-8 text-base'> Working on a fullstack application based in React.js to handle patient requests using medicalAI APIs to serve rural communiites to reduce emergent cases in these localized areas.</p>
       ...
       <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300' >
                <img className = ' w-d20 mx-auto mt-[-30] bg-white' src = {shop} alt = '/' />
                <h2 className='text-2xl font-bold text-center py-8'>
                    Shopper's Companion
                </h2>
                <div className = 'text-center font-medium'>
                <p className='py-2 border-b mx-8  text-base'> Developed a Chrome Extension to store product details from Amazon for users to keep track of later purchases. Integrated Express.js and PostgreSQL to handle the back-end and routing.  </p>
